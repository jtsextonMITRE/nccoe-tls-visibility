...
print(str(Path('_exts').resolve()))

sys.path.append(str(Path('_ext').resolve()))

# -- Project information -----------------------------------------------------

project = "NCCoE TLS Visibility Project"
html_title = "NCCoE TLS Visibility Project"
copyright = 'NIST'
author = 'NIST'
...
exclude_patterns = ['_site', 'Thumbs.db', '.DS_Store', 'tools']
