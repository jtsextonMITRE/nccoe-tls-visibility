...
app = Flask(__name__)
app.secret_key=b"session_handling_secret"
print("Current python directory: %s" % os.getcwd() )
config={}
config['OIDC_CLIENT_SECRETS'] = './oidc-client-secret.txt'
config['SECRET_KEY'] = 'SECRET'
config['OVERWRITE_REDIRECT_URI'] = "https://ek-testapp.visibility.nccoe.org/authorize"
...
db_config={}
db_config['DATABASE_SERVER'] = 'ek-mariadb.visibility.nccoe.org'
